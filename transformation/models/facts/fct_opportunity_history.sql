...
final as (
    select
        ...
        case 
            ...
            when prevamount is not null and cast(prevamount as decimal(15,2)) != cast(amount as decimal(15,2)) then 'Amount Change'
            when prevclosedate is not null and cast(prevclosedate as timestamp) != cast(closedate as timestamp) then 'Close Date Change'
